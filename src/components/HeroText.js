...
const HeroText = () => {
  return (
    <div className="col-span-2 md:px-12 px-4  mt-12 text-left">
      <h2 className="font-abril text-lg opacity-10 md:text-xl xl:text-xl ">
        Hi, I'm
      </h2>
      <h1 className="font-abril text-[1.7rem] md:text-xl xl:text-2xl ">
        Alexandra Haynes
      </h1>
      ...
      <div className="relative w-full flex flex-row items-center justify-between gap-4
       py-2 md:py-8">
        <div className=" h-[1px] md:h-[2px] w-[80%] opacity-30 absolute my-6 bg-slate-400"></div>
        <div className="ml-[42%]">
          <SocialIcons />
        </div>
      </div>

      <p className="font-poppins md:text-base/6 lg:text-md text-[.7rem] w-2/3 pb-8">
