...
const AboutMeText = () => {
  return (
    <div className="px-4 pt-8  text-left">
      ...
      <p className="font-poppins md:text-base/6 max-w-[1600px] text-[.9rem] w-full pb-8">
        <br />
        ...
        Land Forces Academy, earning my master's degree, 
        and managing all the official social media platforms for
        the Romanian military alongside a small team.
        <br />
        <br />
        ...
        development. Recognizing the need for technical expertise in
        community initiatives, I volunteered with Code for Hawaii, a brigade of
        Code for America, to leverage my newfound skills on civic projects.
        <br /> <br />
